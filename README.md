...
### 1. [工厂模式](/design/工厂模式.md)
### 2. [单例模式](/design/单例模式.md)
### 3. [适配器模式](/design/适配器模式.md)
### 4. [装饰器模式](/design/装饰器模式.md)
### 5. [代理模式](/design/代理模式.md)
### 6. [观察者模式](/design/观察者模式.md)
### 7. [发布订阅模式](/design/发布订阅模式.md)
### 8. [外观模式](/design/外观模式.md)
### 9. [迭代器模式](/design/迭代器模式.md)
### 10. [策略模式](/design/策略模式.md)
### 11. [命令模式](/design/命令模式.md)
